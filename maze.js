...
// 		}
		if (thingie.offsetLeft > mazeWidth) {
            ...
            gameOverMessage.textContent = "You did it! Maze conquered. Congratulations!";
            ...
            gameOverMessage.style.letterSpacing = "1px"
            gameOverMessage.style.fontWeight = "bold";
            gameOverMessage.style.fontFamily = "Creepster"

            // Append the game over message to the container element
            cont.appendChild(gameOverMessage);

            const reloadButton = document.createElement("button");
    reloadButton.textContent = "Restart";
    reloadButton.style.position = "absolute";
    reloadButton.style.top = "60%";
    ...
    reloadButton.style.fontFamily = "Creepster"
    ...
    // Append the reload button to the container element
    cont.appendChild(reloadButton);
                    }
